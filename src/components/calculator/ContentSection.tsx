      ...
      <div className="card p-6 sm:p-8 space-y-7">
        ...
        <div>
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            ...
            연 과세 급여에서 근로소득공제(소득 구간별 공제율 적용, 최대 2,000만원)와
            인적공제(부양가족 1인당 150만원)를 차감한 과세표준에 아래 세율을 적용합니다.
            다만 매월 원천징수되는 소득세는 이 누진세율표를 직접 적용하지 않고, 국세청이
            월급여·부양가족 수별로 고시하는 근로소득 간이세액표 조견표를 그대로 조회해
            결정되며, 실제 확정 세액은 다음 해 연말정산을 통해 정산됩니다.
          </p>
          ...
          <p className="text-xs text-slate-500 mt-2">
            * 지방소득세는 소득세의 10%가 추가 부과됩니다.
            근로소득세액공제(총급여 3,300만원 이하 74만원, 소득이 높을수록 최소 20만원까지
            단계적으로 축소) 적용 후 실납부액이 결정됩니다.
          </p>
        </div>
